...
exports.PathArguments = function(...coords) {
    var args = [];
...
exports.rainbow= function(numOfSteps, step) {
    var r, g, b;
...
var rainbow = extensions.rainbow;
var PathArguments = extensions.PathArguments;

var zoomableContent = document.getElementById('canvas_container').getElementsByTagName("*");
var zX = 0.5;
